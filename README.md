...
This is a hand-controlled snake game using Python, Pygame, OpenCV, and Mediapipe.  
...
- Smooth snake movement following your finger (point-to-point, not grid-based)
...
## Real food added (Day 2 update)

 -Added 2 Food insted of Red dot
 -Grapes & Broccali 

 ![Game Screenshot](screenshot_Snakegame1.png)
